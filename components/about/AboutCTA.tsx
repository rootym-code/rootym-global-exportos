 ...
 * Module      : About
 * Feature     : About CTA
 * Purpose     : Displays the About page CTA with CMS-managed
 *               contact information.
 * ============================================================
 */
                ...
                <div className="rounded-3xl bg-white/10 p-8 backdrop-blur">
                  ...
                  <ul className="mt-6 space-y-4 text-green-50">
                    <li className="flex items-start gap-3">
                      ...
                      <span>
                        {t(
                          "about.cta.partner.points.point1"
                        )}
                      </span>
                    </li>
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <span>
                        {t(
                          "about.cta.partner.points.point2"
                        )}
                      </span>
                    </li>
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <span>
                        {t(
                          "about.cta.partner.points.point3"
                        )}
                      </span>
                    </li>
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <span>
                        {t(
                          "about.cta.partner.points.point4"
                        )}
                      </span>
                    </li>
                  </ul>
