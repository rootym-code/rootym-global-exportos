    ...
    <section className="rounded-3xl border border-gray-100 bg-white p-8 shadow-xl">
      ...
      <div className="mt-10 rounded-2xl bg-gradient-to-r from-emerald-600 to-green-600 p-6 text-white">
        ...
        <h3 className="mt-2 text-5xl font-bold">
          72<span className="text-2xl font-semibold">/100</span>
        </h3>

        <p className="mt-5 text-sm font-semibold uppercase tracking-wider opacity-90">
          Mission Status
        </p>
        ...
        <p className="mt-4 text-sm leading-6 opacity-90">
          Complete today's calls and quotations to maximize your chances of
          closing high-value export opportunities.
        </p>
