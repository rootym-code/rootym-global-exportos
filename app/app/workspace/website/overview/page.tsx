...
const websiteAreas = [
  {
    title: "Pages",
    description:
      "Manage website pages and future customer-facing content.",
    icon: FileText,
  ...
  },
  {
    title: "Publishing",
    description:
      "Review website publishing status and future publishing workflows.",
    icon: UploadCloud,
    status: "Preparing" as const,
  },
  {
    title: "Domain",
    description:
      "Connect and manage the domain associated with your website.",
    icon: Globe2,
    status: "Preparing" as const,
  },
  {
    ...
    description:
      "Configure website-level settings and customer-facing preferences.",
    icon: Settings,
    status: "Preparing" as const,
  },
];
...
export default async function WebsiteOverviewPage() {
  ...
  const websiteStatusIcon = getStatusIcon(
  ...
  const domainStatusIcon = getStatusIcon(
      ...
      <div className="mx-auto max-w-7xl px-6 py-8 lg:px-8 lg:py-10">
          ...
          <div className="flex flex-col gap-7 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-3xl">
              ...
              <p className="mt-5 max-w-2xl text-sm leading-7 text-slate-300 sm:text-base">
                View the current state of your ROOTYM website,
                publishing environment, domain connection and
                website readiness from one place.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
              <div>
                ...
                <p className="mt-2 text-sm text-slate-500">
                  Website configuration is scoped to this authenticated
                  customer workspace.
                </p>
              </div>
        ...
        <section className="mt-8">
          <div className="mb-6">
            ...
            <h2 className="mt-2 text-2xl font-bold tracking-tight">
              Website readiness at a glance
            </h2>

            <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-500">
              These indicators represent the current customer
              workspace website configuration state.
            </p>
          </div>
              ...
              <div className="flex-1">
                ...
                <div className="mt-5 grid gap-3 sm:grid-cols-2">
                  ...
                  <div className="flex items-center gap-3 rounded-2xl bg-white px-4 py-3 ring-1 ring-emerald-100">
                    ...
                    <span className="text-sm font-medium text-slate-700">
                      Website configuration preparing
                    </span>
                  </div>
        ...
        <section className="mt-8">
          <div className="mb-6">
            ...
            <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-500">
              Website management capabilities will be enabled
              progressively as the customer website platform is
              implemented.
            </p>
          </div>

          <div className="grid gap-5 md:grid-cols-2">
            {websiteAreas.map((area) => {
