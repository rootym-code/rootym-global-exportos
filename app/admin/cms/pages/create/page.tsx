 ...
 *          using the Website-scoped CMS API while preserving
 *          the same page creation capabilities as the Customer Workspace.
 * ============================================================
 */
...
export default function CreateWebsitePage() {
  ...
  return (
    <div className="space-y-6 pb-10">
      <div>
        <button type="button" onClick={() => router.push("/admin/cms/pages")} className="mb-3 inline-flex items-center gap-2 text-sm font-medium text-gray-500 transition hover:text-[#2E7D32]">
          <ArrowLeft className="h-4 w-4" />
          Back to All Pages
        </button>
        <div className="mb-2 inline-flex items-center rounded-full bg-green-50 px-3 py-1 text-xs font-semibold text-[#2E7D32] ring-1 ring-green-100">Admin Website</div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="sticky bottom-4 z-10 flex flex-col gap-3 rounded-2xl border border-gray-200 bg-white/95 p-4 shadow-xl backdrop-blur sm:flex-row sm:items-center sm:justify-between">
          <Button type="button" variant="outline" onClick={() => router.push("/admin/cms/pages")} disabled={isSaving}>Cancel</Button>
